...
public:
    ...
    public:
        ...
        string_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, tc_t* p__root = 0);
    ...
    public:
        ...
        component_t(kaitai::kstream* p__io, tc_t* p__parent = 0, tc_t* p__root = 0);
...
private:
    ...
    std::vector<circuit_t*>* m_circuits;
    tc_t* m__root;
    kaitai::kstruct* m__parent;
...
public:
    ...
    std::vector<circuit_t*>* circuits() const { return m_circuits; }
    tc_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};
